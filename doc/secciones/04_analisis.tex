...
\begin{itemize}
    ...
    entornos de forma rápida, minimizando el tiempo de instalación y configuración.
\end{itemize}

\subsubsection{Herramientas consideradas}
Se han comparado tres opciones:
\begin{itemize}
    \item \textbf{Poetry}: Implementa de forma nativa los PEP 508 y 518, gestionando
    dependencias y entorno con \texttt{pyproject.toml}. Asegura que las instalaciones sean 
    reproducibles y ofrece una resolución de dependencias rápida y fiable.
    ...
    y dependencias. Es flexible y potente, pero puede ser lenta en proyectos grandes. 
    ...
    \texttt{virtualenv}, pero no es tan popular ni tiene tanta comunidad como \texttt{poetry}.
    ...
    usando el directorio \texttt{\_\_pypackages\_\_} en lugar de \texttt{venv}. Sin embargo,
