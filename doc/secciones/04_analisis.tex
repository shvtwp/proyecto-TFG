...
componentes distintos pero complementarios: por un lado, el motor de base de datos, que es el responsable de 
...
\begin{itemize}
    ...
    No requiere servidor ni configuración adicional, lo que facilita su uso en entornos de desarrollo y pruebas.
...
\begin{itemize}
    ...
    más directa, pero cuenta con una comunidad más reducida y menor integración con herramientas modernas de 
    validación y tipado, lo que limitaría su escalabilidad a medio plazo.

    \item \textbf{Django ORM:} Incluye un potente sistema de gestión de base de datos, pero está diseñado para 
