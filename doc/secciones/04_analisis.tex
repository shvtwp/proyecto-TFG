...
Primero se presentan los criterios empleados para identificar y seleccionar los lenguajes de 
programación más adecuados para el proyecto
...
\begin{itemize}
    \item \textbf{Curva de aprendizaje baja:} se priorizan lenguajes cuya sintaxis sea clara y que
    cuenten con buena documentación.
    \item \textbf{Ecosistema y disponibilidad de librerías: } se valoran positivamente los lenguajes
    con abundantes bibliotecas que faciliten el manejo de datos.
    \item \textbf{Comunidad activa: } la existencia de una comunidad sólida permite encontrar soluciones
    a problemas comunes y reduce los tiempos de desarrollo.
    \item \textbf{Soporte continuo: } se da preferencia a lenguajes con soporte continuo, lo que 
    garantiza mayor sostenibilidad del sistema.
    \item \textbf{Facilidad de despliegue:} se valoran lenguajes que sean fáciles de poner en marcha
    en un servidor o en la nube sin requerir configuraciones complejas.
\end{itemize}
...
Python, ya que ofrece mayor versatilidad para trabajar con datos estructurados y permite, 
a medio y largo plazo, integrar funcionalidades de inteligencia artificial sin grandes 
