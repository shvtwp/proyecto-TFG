...
\begin{itemize}
    ...
    \item \textbf{Flit:} Se centra en la creación de paquetes y su distribución, usa
    ...
    de tests y despliegue, ya que no asegura un entorno consistente. Por lo tanto, esta herramienta por
