...
Aunque \textbf{pipenv} ofrece la ventaja de integrar en un solo comando la gestión del entorno 
virtual y de dependencias, añade una capa de complejidad innecesaria para un proyecto que, por 
ahora, solo requiere definir unas pocas dependencias básicas. 
