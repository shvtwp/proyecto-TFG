...
\subsection{Historias de usuario} \label{sec:historias_usuario}
...
\begin{enumerate}
    ...
    en \href{https://github.com/shvtwp/proyecto-TFG}{GitHub}, la planificación de los hitos y tareas iniciales, y las herramientas para automatizar
