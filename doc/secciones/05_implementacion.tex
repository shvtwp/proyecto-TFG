...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \caption{Esmaltes heráldicos canónicos \cite{esmaltes_wikipedia}.}
        \label{fig:esmaltes}
    \end{figure}
...
pero restringía la capacidad de realizar búsquedas más complejas o de analizar atributos adicionales 
de los escudos.
...
nuevos elementos, las cuáles consisten en:
