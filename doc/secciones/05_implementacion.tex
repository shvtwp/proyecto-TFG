...
Para implementar la búsqueda por el esmalte del campo, primero escribí las pruebas que debía superar
la función. Estas pruebas cubren los criterios de aceptación definidos:
