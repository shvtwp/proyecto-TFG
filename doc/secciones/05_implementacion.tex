...
\paragraph{Tablas}
\begin{itemize}
    \item \textbf{campo}(\textit{id}, \textit{esmalte}, \textit{pieza\_heraldica?})
    \item \textbf{mueble}(\textit{id}, \textit{campo\_id}, \textit{nombre})
    \item \textbf{escudo}(\textit{id}, \textit{nombre}, \textit{portador}, \textit{adorno\_exterior?}, \textit{campo\_id})
\end{itemize}
