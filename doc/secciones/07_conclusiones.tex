...
\begin{itemize}
    \item \textbf{HU1: Estudiante de Historia del Arte.} 
    ...
    \item \textbf{HU2: Investigador en heráldica.} 
...
\textbf{Flask} y \textbf{HTML/CSS}, y se ha desarrollado un sistema de búsqueda textual capaz de 
