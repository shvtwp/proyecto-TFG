...
El sistema desarrollado está pensado para responder a las necesidades de distintos tipos de usuarios 
interesados en la heráldica. Por un lado, ofrece una herramienta útil para estudiantes de Historia del 
Arte u otras disciplinas afines que, al encontrarse ante un escudo en una obra arquitectónica o en un 
monumento, deseen identificar su procedencia. La aplicación permite realizar búsquedas a partir de
atributos visuales, mostrando resultados relevantes y contextualizados. Aunque esta funcionalidad cumple
su propósito, la cantidad de escudos disponibles en la base de datos sigue siendo limitada, por lo que 
se prevé su ampliación en futuras versiones.

Por otro lado, el sistema resulta especialmente valioso para investigadores en heráldica, al facilitar el
análisis, la clasificación y el filtrado de escudos mediante una base de datos estructurada. Esto reduce
la dependencia de fuentes analógicas dispersas y mejora la eficiencia en los procesos de estudio y 
catalogación. Al igual que en el caso anterior, el potencial de la herramienta aumentará conforme se 
amplíe el número de registros heráldicos y se incorporen nuevas funcionalidades de análisis.
