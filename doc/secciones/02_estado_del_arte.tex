...
\begin{itemize}
    \item \textbf{DrawShield \cite{drawshield}:} es una herramienta online que permite generar escudos de armas
    ...
    \item \textbf{Coat of Arms Maker \cite{coat_of_arms}:} son un conjunto de herramientas gráficas que permiten
    ...
    \item \textbf{pyBlazon \cite{pyBlazon}:} es una librería en Python orientada a procesar blasones escritos en
...
\begin{itemize}
    \item \textbf{HERO – Ontology of Heraldry \cite{hero_ontology}:} desarrollada por los Archivos Nacionales de Finlandia, 
    ...
    \item \textbf{Digital Heraldry Ontology (Humboldt-Universität zu Berlin) \cite{digital_heraldry}:} esta ontología surge del
